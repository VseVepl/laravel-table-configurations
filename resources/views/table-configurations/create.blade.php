{{-- File: src/Resources/views/table-configurations/create.blade.php --}}

<div class="container mx-auto p-6">
    <h1 class="text-3xl font-bold mb-6 text-gray-800 dark:text-gray-200">Create Table Configuration</h1>
    ...
    <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6">
        <form wire:submit.prevent="createTableConfiguration">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                @else
                {{-- Keep a hidden input to clear the value if data type changes --}}
